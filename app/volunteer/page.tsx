    ...
    <div className="bg-transparent">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: "70vh", backgroundColor: '#111' }}>
        <div className="absolute inset-0">
          <Image
            src="/images/shared/Newer Pictures/volunteer-giving-products.jpg"
        ...
        <div className="relative z-10 flex min-h-[70vh] items-center pl-6 sm:pl-10 lg:pl-16">
          <div className="max-w-2xl rounded-2xl px-8 py-6" style={{ backgroundColor: 'rgba(0,0,0,0.25)', backdropFilter: 'blur(6px)' }}>
            <Reveal>
            ...
            <Reveal delay={0.1}>
              <h1 className="mt-6 font-serif text-3xl font-normal tracking-tight text-white sm:text-4xl lg:text-5xl" style={{ lineHeight: 1.1 }}>
                Your time makes a{" "}
                <br /><span className="hero-highlight" style={{ color: "#FF8005" }}>real difference</span>
              </h1>
            </Reveal>
            <Reveal delay={0.2}>
