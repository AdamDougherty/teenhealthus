          ...
          <div className="mx-auto max-w-4xl">
            <Reveal>
              ...
              <p className="mx-auto mt-6 max-w-2xl text-center text-base leading-relaxed text-ink/70">
                We are delivering 500 backpacks filled with healthy snacks,
                hydration, and essential supplies to young people experiencing
                homelessness across Los Angeles. Each backpack costs just $25 to
                assemble but delivers $50 in retail value — doubling every
                dollar you give. It&apos;s immediate nourishment, dignity, and
                stability for the youth who need it the most.
              </p>
            </Reveal>
          </div>
        </Container>
